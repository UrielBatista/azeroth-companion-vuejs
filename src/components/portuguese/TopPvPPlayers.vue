    ...
    methods: {
      ...
      async fetchTopPlayers() {
        ...
        try {
          ...
          const response2v2 = await axios.get(`${baseUrl}/${this.getClassName(this.classType)}/2v2`, { headers });
          this.top2v2Players = response2v2.data.slice(0, 3);
  
          const response3v3 = await axios.get(`${baseUrl}/${this.getClassName(this.classType)}/3v3`, { headers });

<template>
  <div class="login-wrapper">
    ...
    <div class="login-container">
      <form @submit.prevent="handleLogin">
        <div class="input-group">
          <label for="username">Nome do Personagem</label>
        ...
        <div class="input-group reign-select">
          <label for="reign-search">Reino</label>
          <input 
            type="text" 
            id="reign-search" 
            v-model="searchTerm" 
    ...
    <ErrorModalPT :is-visible="showModal" @close="closeModal" />
...
import ErrorModalPT from '@/components/portuguese/ErrorModal.vue';

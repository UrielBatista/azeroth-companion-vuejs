...
import TopPvPPlayers from '../../components/english/TopPvPPlayers.vue';
...
export default {
  ...
  methods: {
    ...
    async fetchPvPBracket() {
      ...
      const realmParam = this.realmPath.toLowerCase();
      const nameParam = this.name.toLowerCase();
      const pvp2sUrl = `https://us.api.blizzard.com/profile/wow/character/${realmParam}/${nameParam}/pvp-bracket/2v2?namespace=profile-us&locale=en_US`;
      const pvp3sUrl = `https://us.api.blizzard.com/profile/wow/character/${realmParam}/${nameParam}/pvp-bracket/3v3?namespace=profile-us&locale=en_US`;
